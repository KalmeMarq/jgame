...
public class LevelGen {
    ...
    public LevelGen(int w, int h, int featureSize) {
        ...
        for (int y = 0; y < w; y += featureSize) {
            for (int x = 0;
                 x < w;
                 x += featureSize) {
                setSample(x, y, LevelGen.random.nextFloat() * 2 - 1);
            }
        }
        ...
        do {
            ...
            for (int y = 0; y < w; y += stepSize) {
                for (int x = 0; x < w; x += stepSize) {
                    ...
                    double e = (a + b + c + d) / 4.0 + (LevelGen.random.nextFloat() * 2 - 1) * stepSize * scale;
            ...
            for (int y = 0; y < w; y += stepSize) {
                for (int x = 0; x < w; x += stepSize) {
                    ...
                    double H = (a + b + d + e) / 4.0 + (LevelGen.random.nextFloat() * 2 - 1) * stepSize * scale * 0.5;
                    double g = (a + c + d + f) / 4.0 + (LevelGen.random.nextFloat() * 2 - 1) * stepSize * scale * 0.5;
    ...
    private static byte[][] createTopMap(int w, int h) {
        ...
        for (int i = 0; i < w * h / 2800; i++) {
            int xs = LevelGen.random.nextInt(w);
            int ys = LevelGen.random.nextInt(h);
            for (int k = 0; k < 10; k++) {
                int x = xs + LevelGen.random.nextInt(21) - 10;
                int y = ys + LevelGen.random.nextInt(21) - 10;
                for (int j = 0; j < 100; j++) {
                    int xo = x + LevelGen.random.nextInt(5) - LevelGen.random.nextInt(5);
                    int yo = y + LevelGen.random.nextInt(5) - LevelGen.random.nextInt(5);
        ...
        for (int i = 0; i < w * h / 400; i++) {
            int x = LevelGen.random.nextInt(w);
            int y = LevelGen.random.nextInt(h);
            for (int j = 0; j < 200; j++) {
                int xx = x + LevelGen.random.nextInt(15) - LevelGen.random.nextInt(15);
                int yy = y + LevelGen.random.nextInt(15) - LevelGen.random.nextInt(15);
                if (xx >= 0 && yy >= 0 && xx < w && yy < h) {
                    if (map[xx + yy * w] == Tile.grass.id) {
        ...
        for (int i = 0; i < w * h / 400; i++) {
            int x = LevelGen.random.nextInt(w);
            int y = LevelGen.random.nextInt(h);
            int col = LevelGen.random.nextInt(4);
            for (int j = 0; j < 30; j++) {
                int xx = x + LevelGen.random.nextInt(5) - LevelGen.random.nextInt(5);
                int yy = y + LevelGen.random.nextInt(5) - LevelGen.random.nextInt(5);
                if (xx >= 0 && yy >= 0 && xx < w && yy < h) {
                    if (map[xx + yy * w] == Tile.grass.id) {
                        map[xx + yy * w] = Tile.flower.id;
                        data[xx + yy * w] = (byte) (col + LevelGen.random.nextInt(4) * 16);
                    }
                }
            }
        }
        ...
        stairsLoop:
        for (int i = 0; i < w * h / 100; i++) {
            int x = LevelGen.random.nextInt(w - 2) + 1;
            int y = LevelGen.random.nextInt(h - 2) + 1;
    ...
    private static byte[][] createUndergroundMap(int w, int h, int depth) {
        ...
        if (depth < 3) {
            ...
            stairsLoop:
            for (int i = 0; i < w * h / 100; i++) {
                int x = LevelGen.random.nextInt(w - 20) + 10;
                int y = LevelGen.random.nextInt(h - 20) + 10;
